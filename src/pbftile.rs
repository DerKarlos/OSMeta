...
impl PbfTile {
    ...
    pub fn load(&mut self, renderer: &mut rendf::Renderer, rendere_: &mut rendf::Rendere_, textures: &mut Textures, cars: &mut Cars) -> ViewTile {
        ...
        // next "step"
        self.tile_objects(renderer, rendere_, textures, cars);
    ...
    fn tile_objects(&mut self, renderer: &mut rendf::Renderer, rendere_: &mut rendf::Rendere_, textures: &mut Textures, cars: &mut Cars) {
        ...
        self.create_objects(renderer, rendere_, textures);
    ...
    fn create_objects(&mut self, renderer: &mut rendf::Renderer, rendere_: &mut rendf::Rendere_, textures: &mut Textures) {
      ...
      //for (        index, material_object)  in self.material_objects.iter_mut().enumerate() {
            ...
            material_object.create_object(textures, renderer, rendere_, index);
