use super::geoview::*;
use super::utils::{ScenePos,degr,PI};
use super::osmscene::*;
...
impl CameraView {
     ...
     */
    fn to_geo_view(mut self, osm_scene: OsmScene) -> GeoView {
        ...
        GeoView{
            ...
            dir:     (self.alpha).to_ + 90., //  BJS alpha -90 rad = nord        becomes  API dir  0 degrees = nord
            view:    (self.beta).to_degrees()  - 90., //  BJS beta  +90 rad = horizontal  becomes  API view 0 degrees = horizontal
            radius:  self.radius,
