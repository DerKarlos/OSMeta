...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h19c7620c57d8d8e3: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h9f58f10e0d360ed3: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h5793c14ad77fcbc8: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h116f49e0d45fed0f: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h4d88ff4814613ed4: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__he59553e8767bd529: (a: number, b: number) => void;
